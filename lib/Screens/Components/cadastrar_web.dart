...
class CadastrarWeb extends StatefulWidget {
  @override
  _CadastrarWebState createState() => _CadastrarWebState();
}

class _CadastrarWebState extends State<CadastrarWeb> {
  int _userIndex = 0;
    ...
    return Column(
      children: [
        Container(
          ...
          child: Padding(
            padding: const EdgeInsets.fromLTRB(270.0, 0.0, 270.0, 0.0),
            child: Column(
              children: <Widget>[
                Form(
                  key: _formKey,
  ...
  Widget _userTable() => Padding(
        ...
        child: Column(children: [
          SingleChildScrollView(
            child: Container(
              padding: EdgeInsets.fromLTRB(200.0, 0.0, 200.0, 0.0),
              child: Column(children: [
                Table(
                    border:
                    TableBorder(
